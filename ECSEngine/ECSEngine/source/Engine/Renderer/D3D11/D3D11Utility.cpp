...
D3D11_USAGE D3D11Util::getD3D11Usage(Usage usage) {
    switch (usage) {
...
UINT32 D3D11Util::getD3D11BindFlags(BindFlags flags) {
...
UINT32 D3D11Util::getD3D11CPUAccessFlags(CPUAccessFlags flags) {
...
UINT32 D3D11Util::getD3D11MiscFlags(MiscFlags flags) {
...
D3D11_PRIMITIVE_TOPOLOGY D3D11Util::getD3D11PrimitiveTopology(PrimitiveTopology topology) {
...
DXGI_FORMAT D3D11Util::getDXGIFormat(TextureFormat format) {
